        ...
        describe('Validação de campos', () => {
            ...
            beforeEach(() => {
                stubs = {
                    ...
                    TagService: {
                        ...
                        .stub(TagService, 'criarSeNaoExistir').returns({id: 1, nome: 'tag 1'})
                    }
                }
            })
            afterEach(() => {
            ...
            it('Deve retornar erro se titulo não estiver presente', () => {
              ...
              return expect(ReqAulService.criar(payload)).to.be.eventually
                .rejected
                .and.has.nested.property('message.titulo')
            })
            ...
            it('Deve retornar erro se descricao não estiver presente', () => {
                ...
                return expect(ReqAulService.criar(payload)).to.be.eventually
                  .rejected
                  .and.has.nested.property('message.descricao')
            })
            ...
            it('Deve retornar erro se tag não estiver presente', () => {
                ...
                return expect(ReqAulService.criar(payload)).to.be.eventually
                  .rejected
                  .and.has.nested.property('message.tags')
            })
            ...
            it('Deve retornar erro se data inicio tiver formato inválido', () => {
                ...
                return expect(ReqAulService.criar(payload)).to.be.eventually
                  .rejected
                  .and.has.nested.property('message.horario')
            })
            ...
            it('Deve criar requisicao de aula com sucesso', async () => {
                try{
                    ...
                    await expect(ReqAulService.criar(base))
                        .to.eventually.be.eql({...base, id: 1, tags: [{id: 1, nome: 'tag 1'}]});
                
                    expect(stubs.TagService.criarSeNaoExistir.callCount).to.be.eq(1);
                }catch(e){
                    throw e;
                }
            })
